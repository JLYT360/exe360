    ...
    <>
      ...
      <main className="container">
        ...
        <section className="pricing-section">
          ...
          <div className="pricing-grid">
            <div className="pricing-card">
              ...
              <Link to={`${BASE_PATH}contact?pack=admin-5h`} className="btn btn-primary">Choisir ce forfait</Link>
            </div>
            <div className="pricing-card">
              <h3>10 heures</h3>
              <div className="price">220 €</div>
              <p>Organisation complète</p>
              <Link to={`${BASE_PATH}contact?pack=admin-10h`} className="btn btn-primary">Choisir ce forfait</Link>
            </div>
            <div className="pricing-card featured">
              <h3>Mensuel (20h)</h3>
              <div className="price">420 €/mois</div>
              <p>Gestion administrative continue</p>
              <Link to={`${BASE_PATH}contact?pack=admin-mensuel`} className="btn btn-primary">Choisir ce forfait</Link>
            </div>
            <div className="pricing-card">
              <h3>Annuel (240h)</h3>
              <div className="price">4 500 €/an</div>
              <p>Partenaire administratif</p>
              <Link to={`${BASE_PATH}contact?pack=admin-annuel`} className="btn btn-primary">Choisir ce forfait</Link>
            </div>
          </div>
        ...
        <section className="cta-section">
          ...
          <Link to={`${BASE_PATH}contact?pack=admin-devis`} className="btn btn-primary">Demander un devis</Link>
        </section>
      </main>
      <Footer />
    </>
