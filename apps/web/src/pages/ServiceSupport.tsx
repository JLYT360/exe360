    ...
    <>
      ...
      <main className="container">
        ...
        <section className="pricing-section">
          ...
          <div className="pricing-grid">
            <div className="pricing-card">
              ...
              <a href={`/contact?pack=support-5h`} className="btn btn-primary">Choisir ce forfait</a>
            </div>
            <div className="pricing-card">
              <h3>10 heures</h3>
              <div className="price">280 €</div>
              <p>Formation complète</p>
              <a href={`/contact?pack=support-10h`} className="btn btn-primary">Choisir ce forfait</a>
            </div>
            <div className="pricing-card featured">
              <h3>Mensuel (10h)</h3>
              <div className="price">260 €/mois</div>
              <p>Maintenance & formation</p>
              <a href={`/contact?pack=support-mensuel`} className="btn btn-primary">Choisir ce forfait</a>
            </div>
            <div className="pricing-card">
              <h3>Annuel (120h)</h3>
              <div className="price">2 880 €/an</div>
              <p>Partenaire informatique</p>
              <a href={`/contact?pack=support-annuel`} className="btn btn-primary">Choisir ce forfait</a>
            </div>
          </div>
        ...
        <section className="cta-section">
          ...
          <a href={`/contact?pack=support-diagnostic`} className="btn btn-primary">Demander un diagnostic numérique</a>
        </section>
      </main>
      <Footer />
    </>
