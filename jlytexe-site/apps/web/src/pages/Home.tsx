      ...
      <main className="container">
        <section className="hero">
          ...
          <div className="cta-group">
            <a href="/contact" className="btn-primary">Demander un diagnostic express</a>
            <a href="/tarifs" className="btn-secondary">Voir les offres</a>
          </div>
        ...
        <section className="grid">
          <a href="/services/marketing-strategique" className="card card-clickable">
            <h3>Marketing stratégique</h3>
            <p>Plans marketing & communication, lancement, croissance, pilotage.</p>
            <div className="card-arrow">→</div>
          </a>
          <a href="/services/assistance-administrative" className="card card-clickable">
            <h3>Assistance administrative</h3>
            <p>Organisation, relances, modèles, suivi efficace.</p>
            <div className="card-arrow">→</div>
          </a>
          <a href="/services/precomptabilite" className="card card-clickable">
            <h3>Pré-comptabilité</h3>
            <p>Saisie & préparation pour l'expert‑comptable, tableaux de bord.</p>
            <div className="card-arrow">→</div>
          </a>
          <a href="/services/support-informatique" className="card card-clickable">
